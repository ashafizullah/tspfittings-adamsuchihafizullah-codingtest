...
<template>
    ...
    >
        ...
        <IconHistory v-else :size="iconSize" :stroke-width="strokeWidth" class="flex-shrink-0" />
...
const props = defineProps({
    ...
    variant: {
        type: String,
        default: 'info' // Mengubah default variant menjadi info
    },
    size: {
        type: String,
        default: 'sm',
