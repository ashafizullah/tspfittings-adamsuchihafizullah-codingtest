<template>
	...
	<Head>
		<title>Perbarui Role - {{ title() }}</title>
	</Head>
	<main class="c-main">
					...
					<div class="col-md-12">
						<div class="card border-0 rounded-3 shadow border-top-purple">
							<div class="card-header">
								<span class="font-weight-bold"><i class="fa fa-shield-alt"></i> Perbarui Role</span>
							</div>
							<div class="card-body">
								...
								<form @submit.prevent="submit">
									...
									<div class="row">
										<div class="col-12">
											<button class="btn btn-primary shadow-sm rounded-sm" type="submit">Perbarui</button>
...
export default {
	...
	setup(props) {
		...
		const submit = () => {
			...
			//send data to server
			router.put(`/apps/roles/${props.role.id}`, {
				//data
				name: form.name,
