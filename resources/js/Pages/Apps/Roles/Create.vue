<template>
	...
	<Head>
		<title>Tambah Role Baru - {{ title() }}</title>
	</Head>
	<main class="c-main">
					...
					<div class="col-md-12">
						<div class="card border-0 rounded-3 shadow border-top-purple">
							<div class="card-header">
								<span class="font-weight-bold"><i class="fa fa-shield-alt"></i> Tambah Role Baru</span>
							</div>
							<div class="card-body">
								...
								<form @submit.prevent="submit">
									...
									<hr>
									<div class="mb-3">
										<label class="fw-bold">Pilih Permissions</label>
										<br>
